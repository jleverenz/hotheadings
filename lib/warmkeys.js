...
/* This is a copy of the sdk/keyboard/hotkeys.js module for the HotHeadings
 * (HH) add-on.  The version shipped with the API was to restrictive, forcing
 * use of modifier keys.  HH uses a traditional hotkey for toggling it's mode.
 * When enabled, normal keys without modifiers, like 'h', trigger action. */
...
const { observer: keyboardObserver } = require("sdk/keyboard/observer");
const { getKeyForCode, normalize, isFunctionKey,
        MODIFIERS } = require("sdk/keyboard/utils");
